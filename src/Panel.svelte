  ...
  onMount(() => {
    ...
    .call(d3.drag()
      .on("drag", function(d) {
          ...
          plugs[elName].x = d.x -40;
          plugs[elName].y = d.y -80;
          ...
          plugs[elName].y = (which_row_index * CELL_HEIGHT) + JACK_TOP_OFFSET;
          ...
          plugs[elName].x = (which_col_index * CELL_WIDTH) + (CELL_WIDTH/2) - 55;
